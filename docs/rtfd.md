...
By default, the [puppet-db](https://github.com/ULHPC/pupper-db) repository is bound to the [ulhpc-puppet-db](http://ulhpc-puppet-db.rtfd.org) project on Read the Docs (to avoid confusion with other db projects). 
